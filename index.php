...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/zanime.css" />
    <link rel="stylesheet" type="text/css" href="css/cype.css" />
...
<body>
                    ...
                    <div class="col-sm-7 col-md-6">
                        <div class="topbar-right">
                            <ul class="topbar-sosmed">
                                <li>
                                    <a href="tel:+33230961744"><i class="fa fa-phone"></i> 0230961744 </a>
                                </li>
                                <li>
                                    <a href="mailto:contact@cypefrance.com"><i class="fa fa-envelope"></i>
                                        contact@cypefrance.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <nav class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="#rd" class="dropdown-toggle anime">R&D</a>
                            </li>
                            <li class="dropdown">
                                <a href="#equipe" class="dropdown-toggle anime">EQUIPE</a>
                            </li>
                            <li class="dropdown">
    ...
    <!-- Accueil -->
    <div id="accueil" class="video-background-holder">
        <div class="video-background-overlay"></div>
        <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
            <source src="images/cypevideo.mp4" type="video/mp4">
        </video>
    ...
    <!-- Partenaire -->
    <div id="partenaire" class="section project bg-grey">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <h2 class="section-heading center">
                ...
                <div id="caro-project">
                    ...
                    <div class="item">
                        <div class="feature-box-7">
                            <div class="media">
                                <img src="images/part_batylab.png" alt="rud" class="img-responsive">
                            </div>
                        </div>
                    </div>
                    <!-- Item 2 -->
                    <div class="item">
                        <div class="feature-box-7">
                            <div class="media">
                                <img src="images/part_ire.png" alt="rud" class="img-responsive">
                            </div>
                        </div>
                    </div>
                    <!-- Item 3 -->
                    ...
                    <div class="item">
                        <div class="feature-box-7">
                            <div class="media">
                                <img src="images/part_building.png" alt="rud" class="img-responsive">
                            </div>
                        </div>
                    </div>
                    <!-- Item 4 -->
                    <div class="item">
                        <div class="feature-box-7">
                            <div class="media">
                                <img src="images/icert.png" alt="rud" class="img-responsive">
                            </div>
                        </div>
                    </div>
                    <!-- Item 5 -->
                            ...
                            <ul class="list-info">
                                ...
                                <a class="text_link" href="mailto:contact@cypefrance.com">
                                    <li>
                                        ...
                                        <div class="info-text">contact@cypefrance.com</div>
                                    </li>
                                </a>
                                <li>
                                    <div class="info-icon">
                    ...
                    <div class="col-sm-9 col-md-9">
                        <div class="content">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="p_subject" placeholder="Sujet" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="p_phone" placeholder="Téléphone" required>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="footer-item">
                        <div class="footer-sosmed">
                            <a href="https://www.linkedin.com/company/cype-france/" title="">
                                <div class="item">
